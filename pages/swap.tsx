            ...
            <div className="main-bg" style={styles.main_bg}>
                <div style={styles.center_box}>
                    <div className="top">
                        ...
                        <div className="icons">
                            <img alt="icon" src="/static/img/Frame1.svg" width={20} height={20}/>
                            <img
                                style={{marginLeft: 26}}
                                alt="icon"
                                src="/static/img/Frame2.svg"
                                width={26}
                                height={26}
                            />
                        </div>
                    ...
                    <div className="con">
                        ...
                        <div className="exc-box" style={{marginTop: 24}}>
                            ...
                            <input className="exc-ipt" type="text" value={token0Value} onChange={event => {
                        ...
                        <div className="exc-icon">
                            <img alt="icon" src="/static/img/Group1.svg" width={40} height={41}/>
                        </div>
                        <div className="exc-box">
                            ...
                            <input className="exc-ipt" type="text" value={token1Value} onChange={event => {
                                let inputValue
                                if (!event.target.value || event.target.value === '') {
                                    inputValue = 0
                                } else {
                        ...
                        <div className="exc-bot">
                            <span>Price</span>
                            <span>{token0Value} {selectedTokens[0].name} ≈ {token1Value} {selectedTokens[1].name}</span>
                        </div>
